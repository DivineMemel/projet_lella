...
// export default function Collecteur() {
//   const [name, setName] = useState("");
//   const router = useRouter();

//   const handleSubmit = () => {
//     router.push(`/form/collecteur/${name}`); // Redirige vers le formulaire du collecteur
//   };

//   return (
//     <View className="flex-1 p-6 bg-secondary">
//       <Text className="text-2xl font-bold text-primary mb-4">Inscription du collecteur</Text>
//       <TextInput
//         className="border p-3 rounded-lg bg-white mb-4"
//         placeholder="Entrez votre nom"
//         value={name}
//         onChangeText={setName}
//       />
//       <TouchableOpacity onPress={handleContinue} className="bg-primary p-4 rounded-lg">
